      ...
      <Card>
        ...
        <CardBody>
          <div className="hotel-cards">
            <p className="hotel-card__description">Below are just a few of the hotels in the area. The highlighted hotel has a room block for our wedding, but of course please feel free to book anywhere you'd feel most comfortable!</p>
